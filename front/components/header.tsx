  ...
  return (
    <header className="flex h-16 items-center justify-between border-b bg-background px-4 shadow-sm">
      <div className="flex items-center">
        ...
        <h1 className="text-xl font-semibold">LLM Training Dashboard</h1>
      </div>
      <div className="flex items-center gap-4">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem>Training job #1234 completed</DropdownMenuItem>
            <DropdownMenuItem>New dataset uploaded</DropdownMenuItem>
